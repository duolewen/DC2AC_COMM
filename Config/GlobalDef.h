...
#define LENGTH_MODBUS_TX  256
#define LENGTH_MODBUS_RX  256
...
#define MODBUSCOMM_TXDMA    DMA0
#define MODBUSCOMM_TXDMA_CH DMA_CH1

#define MODBUSCOMM_RXDMA    DMA0
#define MODBUSCOMM_RXDMA_CH DMA_CH2
